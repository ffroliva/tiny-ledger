...
import com.flaviooliva.ledger.api.generated.api.BalanceApi;
import com.flaviooliva.ledger.api.generated.model.Account;
import com.flaviooliva.ledger.api.generated.model.AccountList;
...
import com.flaviooliva.ledger.api.generated.model.TransactionList;
...
import com.flaviooliva.ledger.config.AuthorizationConfig;
...
public class BalanceController implements BalanceApi {
    ...
    public ResponseEntity<Balance> getBalance(UUID accountUid, String consistency) {
        BalanceView view = queryBalance
                .balance(new com.flaviooliva.ledger.shared.AccountId(accountUid))
    ...
    public ResponseEntity<TransactionList> listTransactions(
        ...
        HistoryPage page = queryHistory.history(
                new com.flaviooliva.ledger.shared.AccountId(accountUid),
    ...
    private static Money money(com.flaviooliva.ledger.shared.Money money) {
