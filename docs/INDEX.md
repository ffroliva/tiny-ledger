...
| `spec.md` (v3.32) | Any question about *contract* — API shape, errors (§6.5), security model (§6.4), idempotency (§6.3), observability and health (§6.6), the two run modes (§1), module boundaries (§3/§4) | Explanation |
