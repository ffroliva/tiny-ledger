...
They lived at `docs/superpowers/plans/` and `docs/superpowers/specs/` until 2026-08-06. Paths of that
form appearing *inside* these files — including inside recorded `git` commands — are left as they were
